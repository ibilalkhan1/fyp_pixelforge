...
func AssertSurfaceEqual[T comparable](t *testing.T, expected, actual pixelforge.Surface[T]) (equal bool) {
	t.Helper()
...
func AssertSpriteEqual(t *testing.T, expected, actual pixelforge.Sprite) {
	t.Helper()
