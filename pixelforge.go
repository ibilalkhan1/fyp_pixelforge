// Package pixelforge provides the core Pixelforge functions for the game loop,
...
// You should not call Pixelforge's API from any goroutine other than the one
// running your `pixelforge.Update` and `pixelforge.Draw` functions. You can still
// create your own goroutines in your game, but they must not call
// any Pixelforge functions or access Pixelforge state.
package pixelforge
