...
import (
	...
	"github.com/ibilalkhan1/fyp_pixelforge/internal/fileloc"
)
...
func (t *target[T]) Subscribe(event T, f func(T, Handler)) Handler {
	...
	h.event = event
	if !GlobalTracingOff {
		h.fileLoc = fileloc.Get("github.com/ibilalkhan1/fyp_pixelforge/pixelforge_event.") // skip pievent wrapper created in Subscribe function
	}
